...
#include "local_fine_pool_log_steal.h"
...
LocalFinePoolLogSteal::~LocalFinePoolLogSteal() {
...
void LocalFinePoolLogSteal::Submit(Task task) {
...
void LocalFinePoolLogSteal::WaitUntilFinished() {
